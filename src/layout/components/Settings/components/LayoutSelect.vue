 ...
 * @property {string} modelValue - 当前布局值
 */
...
.layout-item.mix div:nth-child(1),
.layout-item.top div:nth-child(1) {
  width: 100%;
  height: 30%;
  background: #1b2a47;
...
.layout-item.mix div:nth-child(2) {
  position: absolute;
  bottom: 0;
  left: 0;
  width: 30%;
...
.layout-item.left div:nth-child(1) {
  width: 30%;
  height: 100%;
  background: #1b2a47;
}

.layout-item.left div:nth-child(2) {
  position: absolute;
  top: 0;
  right: 0;
  width: 70%;
