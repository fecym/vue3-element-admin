  ...
  routes.forEach(route => {
    ...
    if (route.meta?.affix) {
      tags.push({
        ...
        title: route.meta?.title || route.title || "no-name",
...
function initTags() {
  ...
  const tags = filterAffixTags(permissionStore.menuList);
...
const againActiveTop = newVal => {
  ...
  const parent = findOutermostParent(permissionStore.menuList, newVal);
